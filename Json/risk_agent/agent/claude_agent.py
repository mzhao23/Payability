...
def _build_user_message(
    ...
    payload: dict[str, Any] = {
        ...
        "inv_credit_card_notification":   fs.inv_credit_card_notification,
...
_RULE_METRIC_MAP: dict[str, list[str]] = {
    ...
    "ACC_DEACTIVATION":         ["high_risk_notification_count"],
    "INV_CREDIT_CARD":          ["inv_credit_card_notification"],
    "TWO_STEP_VERIFICATION":    ["two_step_verification"],
    "CUSTOMER_COMPLAINT":       ["cust_complaints_prod_authenticity", "cust_complaints_prod_safety", "cust_complaints_intelectual_prop", "cust_complaints_policy_violation"],
...
def _metrics_for_triggered_rules(fs: FeatureSet, triggered_rules: list[str]) -> list[Metric]:
    ...
    all_metrics: dict[str, Metric] = {
        ...
        "inv_credit_card_notification":    Metric(metric_id="inv_credit_card_notification",    value=fs.inv_credit_card_notification if fs.inv_credit_card_notification else None, unit=None),
